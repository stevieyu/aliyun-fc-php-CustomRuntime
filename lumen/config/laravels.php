...
return [
    ...
    'listen_port'              => env('LARAVELS_LISTEN_PORT', $_ENV['FC_SERVER_PORT'] ?? 9000),
    ...
    'swoole'                   => [
        ...
        'dispatch_mode'      => 2,
        'reactor_num'        => env('LARAVELS_REACTOR_NUM', function_exists('swoole_cpu_num') ? swoole_cpu_num() * 2 : 1),
        'worker_num'         => env('LARAVELS_WORKER_NUM', function_exists('swoole_cpu_num') ? swoole_cpu_num() * 2 : 2),
        //'task_worker_num'    => env('LARAVELS_TASK_WORKER_NUM', function_exists('swoole_cpu_num') ? swoole_cpu_num() * 2 : 2),
        'task_ipc_mode'      => 1,
